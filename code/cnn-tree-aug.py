...
def disagg_fold(dataset, fold_num, lr, p, aug_rate):
...
train_fold, valid_fold, test_fold, train_error, valid_error, test_error, train_losses, valid_losses, test_losses = disagg_fold(dataset, fold_num, lr, p, aug_rate)

directory = "./baseline/cnn-tree-aug/{}/{}/{}/{}/{}".format(dataset, fold_num, lr, num_iterations, p)
