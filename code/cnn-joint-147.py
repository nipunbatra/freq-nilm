...
class CustomCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 16, kernel_size=(14, 7), stride=1, padding=2)
        self.bn1 = nn.BatchNorm2d(16)

        self.conv2 = nn.Conv2d(16, 32, kernel_size=2, stride=(1, 2), padding=1)
        self.bn2 = nn.BatchNorm2d(32)

        self.conv5 = nn.ConvTranspose2d(32, 16, kernel_size=2, stride=(1, 2), padding=1)
        self.bn5 = nn.BatchNorm2d(16)

        self.conv6 = nn.ConvTranspose2d(16, 1, kernel_size=(14, 7), stride=1, padding=2)
...
directory = "./baseline/cnn-joint/14_7/{}/{}/{}/{}/{}".format(dataset, fold_num, lr, num_iterations, p)
