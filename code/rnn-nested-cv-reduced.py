...
np.save('./baseline/rnn-tree-order/valid-pred-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), valid_fold)
np.save('./baseline/rnn-tree-order/valid-error-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), valid_error)
np.save('./baseline/rnn-tree-order/train-pred-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), train_fold)
np.save('./baseline/rnn-tree-order/test-pred-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), test_fold)
np.save('./baseline/rnn-tree-order/test-error-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), test_error)
np.save('./baseline/rnn-tree-order/test-losses-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), test_losses)
np.save('./baseline/rnn-tree-order/valid-losses-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-reduced'.format(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, ORDER), valid_losses)
