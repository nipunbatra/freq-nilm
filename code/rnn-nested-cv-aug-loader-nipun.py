...
def disagg_fold(fold_num, dataset, cell_type, hidden_size, num_layers, bidirectional, lr, num_iterations, p, num_aug, case):
...
num_iterations = 2000
p = 0
orders = np.load("/Users/nipun/Downloads/rnn-greedy2-orders.npy").item()
...
np.save('./baseline/aug_data/valid-losses-{}-{}-{}-{}'.format(fold_num, dataset, num_aug, case), valid_losses)
