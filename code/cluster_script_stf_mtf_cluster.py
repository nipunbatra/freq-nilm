		...
		for num_latent in range(1, 21):
			for lr in [0.01, 0.1 ,1 ,2]:
				for iters in range(100, 2600, 400):
					...
					CMD = 'python baseline-stf-nested-cluster-valid.py {} {} {} {} {} {}; python baseline-mtf-nested-cluster-valid.py {} {} {} {} {} {}'.format(dataset, cluster, cur_fold, num_latent, lr, iters, dataset, cluster, cur_fold, num_latent, lr, iters)
					lines = []
					lines.append("#!/bin/sh\n")
