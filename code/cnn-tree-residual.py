...
best_params = np.load("./baseline/result/best_residual_ind_param.npy").item()


residual = np.load("./baseline/result/cnn-tree/5/{}/{}/200000/0.0/test-pred-[\'residual\'].npy".format(fold_num, best_params[fold_num]['lr']) ).item()[best_params[fold_num]['iters']
