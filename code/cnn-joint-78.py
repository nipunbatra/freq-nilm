...
class CustomCNN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 16, kernel_size=(7, 8), stride=1, padding=2)
        ...
        self.conv6 = nn.ConvTranspose2d(16, 1, kernel_size=(7, 8), stride=1, padding=2)
...
directory = "./baseline/cnn-joint/7_8/{}/{}/{}/{}/{}".format(dataset, fold_num, lr, num_iterations, p)
