...
np.save("./baseline/stf-cluster/stf-pred-{}-{}-{}-{}-{}-{}.npy".format(dataset, cluster, cur_fold, r, lr, num_iter), pred)
np.save("./baseline/stf-cluster/stf-error-{}-{}-{}-{}-{}-{}.npy".format(dataset, cluster, cur_fold, r, lr, num_iter), error)
