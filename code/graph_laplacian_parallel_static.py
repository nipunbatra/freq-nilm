...
# Only use homes with all static features
...
directory = os.path.expanduser('~/git/scalable-nilm/aaai18/predictions/static/TF-all/{}/case-{}/{}/{}'.format(setting, case, static_use, constant_use))
